...
<body id="page-top">
	...
	<div id="wrapper">
        ...
        <div class="form-group row">
            <label for="kriteria" class="col-sm-1 col-form-label">No </label>
            <div class="col-sm-4">
            <input type="text" value = <?php echo $data_edit['transaksi']->notrans ?>  name="notrans" class="form-control" required/>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
            <input type="text" value = <?php echo $data_edit['transaksi']->tanggal ?>   name="tanggal" class="form-control tanggal" required/>
            </div>

            <label for="divisi" class="col-sm-1 col-form-label">Divisi</label>
            <div class="col-sm-4">
            <input type="number" value = <?php echo $data_edit['transaksi']->divisi ?>  name="divisi"  class="form-control" id="divisi" placeholder="divisi" required>
            </div>
            
        </div>
        <?php
                        foreach($data_edit_detail['transaksidetail'] as $key => $value){ 
            ...
            <div id="dynamic_field">
                <div class="form-group ">
                    ...
                    <div class="col-sm-1">
                        ...
                        <?php
                        // foreach($data['kriteriabuah'] as $data){ // Lakukan looping pada variabel siswa dari controller
